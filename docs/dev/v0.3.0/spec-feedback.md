# IdeaMark Core v1.2.0 — Implementation Feedback from IdeaMark CLI v0.3.0

**Status:** living document during v0.3.0 development; intended for the IdeaMark Core
...
against the v0.3.0 rule checklist (Phase 0, 2026-07-06):
