...
**Contract version:** `1.2.0-draft.1`  
**Tool version:** ideamark-cli v0.3.0  
...
Commands in v0.3.0 scope: `validate`, `format`, `migrate`, `ls`, `describe`,
...
```json
{"kind":"meta","tool":"ideamark-cli","tool_version":"0.3.0","contract_version":"1.2.0-draft.1","command":"validate","mode":"core","spec_version_detected":"ideamark-core-v1.2.0","input":"path/or/-"}
...
- The v0.2.0 flags `--strict` (alias for `--mode strict`) is kept; the old `working`
  mode name is removed. Evidence flags (`--emit-evidence` etc.) are dropped in v0.3.0.
...
- Topics as in v0.2.0 (`capabilities`, `checklist`, `vocab`, `ai-authoring`,
  ...
  `capabilities` reports the v0.3.0 command surface and this contract version.
...
```json
{"tool":{"version":"0.3.0"},"contract":{"version":"1.2.0-draft.1"},"document_spec":{"version":"ideamark-core-v1.2.0"}}
```
