```yaml
ideamark_version: 1
doc_id: "ideamark.cli.v0.1.3.dev-spec.v0.0.4.2026-02-28"
doc_type: "spec"
status: "in_progress"
...
# Section 007 : Guides Gap Analysis & Redesign（v0.0.4 追加）
...
# Section 008 : ai-small Guides JSON Concrete Spec（v0.0.4 追加）
...
# Section 009 : Guides Profiles Strategy（ai-small固定手順 / ai-largeフレームワーク）（v0.0.4 追加）
