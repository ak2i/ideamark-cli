...
v1.1.2 は v1.1.1 の互換更新であり、`describe params` の基本 shape は v1.1.1 と同じである。
...
`describe params` SHOULD explicitly state that the document baseline is YAML-based in the v1.1.x line.
